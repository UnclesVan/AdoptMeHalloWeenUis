...
candyCorn.Size = UDim2.new(0.35, 0, 0.9, 0) -- Significantly increased size of the candy corn
candyCorn.Position = UDim2.new(0.02, 0, 0.05, 0) -- Adjusted position for closeness
...
amountDisplay.Size = UDim2.new(0.55, 0, 0.5, 0) -- Width of the amount display
amountDisplay.Position = UDim2.new(0.4, 0, 0.25, 0) -- Position adjusted for closeness
