...
amountDisplay.Size = UDim2.new(0.8, 0, 1, 0)
amountDisplay.Position = UDim2.new(0.2, 0, 0, 0)
...
candyCorn.Size = UDim2.new(0.2, 0, 1, 0)
candyCorn.Position = UDim2.new(0, 0, 0, 0)
candyCorn.BackgroundTransparency = 1
candyCorn.Image = "rbxassetid://2576547983"
